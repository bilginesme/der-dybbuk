...
export class Dice extends Phaser.GameObjects.Sprite {
  private isPawnMowing: boolean = false;
  private isDiceRolling: boolean = false;
  ...
  private handlePointerDown(
    ...
    if (this.isDiceRolling || this.isPawnMowing) {
      return;
    }
  ...
  public sendMessagePawnMovementStarted(): void {
      this.isPawnMowing = true;
  }

  public sendMessagePawnMovementCompleted(): void {
      this.isPawnMowing = false;
  }
}